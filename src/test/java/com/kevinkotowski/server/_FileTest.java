...
public class _FileTest {
    ...
    //       cover listFiles(), because that is original code. It will not
    //       cover writeln(), because there is a series of java.io classes
    //       without material custom logic. The impact of Mocking out each
    //       class in the chain would really just serve to test java.io.
